...
export default function WithAsync() {
  ...
  const deleteStudent = async (id: any) => {
    setActions({ ...actions, loader: true })
    const resp = await fetch(`https://kisalayakgschool.com/api/deleteStudent/${id}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        'Accept': 'application/json',
  ...
  const statusStudent = async (id: any) => {
    setActions({ ...actions, loader: true })
    const resp = await fetch(`https://kisalayakgschool.com/api/statusStudent/${id}`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
        'Accept': 'application/json',
