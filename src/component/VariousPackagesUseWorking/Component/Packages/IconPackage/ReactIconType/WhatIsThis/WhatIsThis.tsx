          ...
          <div className='vpu_ocoplmimotca_item'>
            <ul>
              <li className="vpu_ocoplmimotcai_heading">
                <span>This is <b>react icon</b> package to manage the <b>icons</b></span>
              </li>
                  ...
                  <div className="vpu_npm_list">
                    <p>
                      ...
                      <div className="vpu_npm_package">
                        <a>npm install react-icons --save</a>
                      </div>
                    </p>
                  </div>
                </div>
              ...
              <li className="vpu_ocoplmimotcai_site">
                ...
                <div>
                  <a className="visitDoc" href="https://react-icons.github.io/react-icons/" target="_blank">https://react-icons.github.io/react-icons/</a>
                </div>
              </li>
              <li>
