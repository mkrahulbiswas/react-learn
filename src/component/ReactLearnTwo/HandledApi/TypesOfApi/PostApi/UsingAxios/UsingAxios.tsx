...
export function WithoutAsyncAndService({ getData }: any) {
  ...
  const saveStudent = (event: any) => {
    ...
    axios.post("https://kisalayakgschool.com/api/saveStudent",
      fromData,
      {
        headers: {
...
export function WithoutAsyncButWithService({ getData }: any) {
  ...
  const saveStudent = (event: any) => {
    event.preventDefault()
    saveStudentApi(fromData).then((resp) => {
...
export function WithAsyncButWithoutService({ getData }: any) {
  ...
  const saveStudent = async (event: any) => {
    event.preventDefault()
    const resp = await axios.post("https://kisalayakgschool.com/api/saveStudent",
      fromData,
      {
        headers: {
          'X-Mashape-Key': 'required',
...
export function WithAsyncAndService({ getData }: any) {
  ...
  const saveStudent = async (event: any) => {
    event.preventDefault()
    const resp = await saveStudentApi(fromData)
    if (resp.data.status == 1) {
      getData()
    }
  }
